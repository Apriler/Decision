...
public class MainActivity extends AppCompatActivity {
    ...
    private class OnCoinClickListener implements OnClickListener {
        ...
        public void onClick(View view) {
            MainActivity.this.startAnimation(); // 播放翻转硬币视频
        }
    }
    ...
    private void init() {
        ...
        this.mVideoView.setOnCompletionListener(new OnCompletionListener() { // 视频播放完成后的监听
            public void onCompletion(MediaPlayer mediaPlayer) {
                MainActivity.this.mEmptyView.setOnClickListener(new OnCoinClickListener()); // 视频播放完成后再次给mEmptyView绑定监听事件
            }
        });
